#' Covariance Matrix of Two Weighted Log-rank Tests (Stratified) At Two Analyses
#'
...
#' data.IA$strata1 = data.FA$strata1 = sample(c(1,2), 672, replace = TRUE);
#' data.IA$strata2 = data.FA$strata2 = sample(c(1,2), 672, replace = TRUE);
#' data.IA$strata3 = data.FA$strata3 = sample(c(1,2), 672, replace = TRUE);
#' 
#' group = as.numeric(data.IA$treatment == "experimental")
#' wlr.cov2t(time1=data.IA$survTimeCut, event1=1-data.IA$cnsrCut, time2=data.FA$survTimeCut, event2=1-data.FA$cnsrCut, group=group, rho1=0, gamma1=0, tau1 = NULL, s.tau1=0,rho2=0, gamma2=0, tau2 = NULL, s.tau2=0,f.ws1=NULL, f.ws2=NULL, strata1=data.IA$strata1, strata2=data.IA$strata2, strata3=data.IA$strata3)
#' 
#' @export  
#' 
